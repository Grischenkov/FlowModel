- Первый запуск продукта может занимать несколько минут из-за инициализации файла БД и заполнения ее значениями "по умолчанию".
...
Copyright © 2020 Grishchenkov Nikita
...
ТРЕБОВАНИЯМ, В ТОМ ЧИСЛЕ, ПРИ ДЕЙСТВИИ КОНТРАКТА, ДЕЛИКТЕ 
ИЛИ ИНОЙ СИТУАЦИИ, ВОЗНИКШИМ ИЗ-ЗА ИСПОЛЬЗОВАНИЯ ПРОГРАММНОГО 
